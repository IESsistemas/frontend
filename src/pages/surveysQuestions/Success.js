                                    ...
                                    <Card className="mt-4">
                                        <CardBody className="p-4 text-center">
                                            ...
                                            <div className="mt-4 pt-2">
                                                <h4>¡Bien hecho!</h4>
                                                <p className="text-muted mx-4">Tu encuesta fue enviada correctamente.</p>
                                                <div className="mt-4">
                                                    <Link to="/ies/surveys" className="btn btn-success w-100 ies_successgreenbgBut">Cerrar</Link>
                                                </div>
                                            </div>
                                        </CardBody>
                                    </Card>
