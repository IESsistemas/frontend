...
const AcademicExceptionsListener = (props) => {
    document.title = "IES - Solicitud Excepciónes Académicas";

    const [selectedOptions, setSelectedOptions] = useState({}); // Estado local para almacenar las selecciones en el primer select
    ...
    const { user, career, listener, exception, commissions } = useSelector((state) => ({
                ...
                <Container fluid>
                    <Row>
                        <Col xs="12" className="mb-3">
                            ...
                            <h4>EXCEPCIÓN PARA CURSAR DE OYENTE</h4>
                    ...
                    <Row className="mt-4">
                        ...
                        {
                            listener && Object.keys(listener).length > 0 ?
                                                ...
                                                <tbody style={{ backgroundColor: "white" }}>
                                                    <tr>
                                                        <td>
                                                            ...
                                                            >
                                                                <option disabled >Selecciona asignatura</option>
                                                                {
                                                                    Object.keys(listener).map((data, index) => (
                                                        ...
                                                        <td>
                                                            ...
                                                            >
                                                                ...
                                                                {
                                                                    listener && listener[validation.values.subjects] && listener[validation.values.subjects].map((data, index) => (
...
export default withRouter(AcademicExceptionsListener);
