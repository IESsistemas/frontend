                            ...
                            <Row>
                                <Col lg={12}>
                                    <div className="text-center pt-4">
                                        ...
                                        <div className="mt-n4">
                                            <h3 className="text-uppercase">USUARIO INHABILITADO</h3>
                                            <h3 className="">Solicite ayuda en el siguiente correo electrónico: <span className='ies_fw100'>cristianroldan@ies21.edu.ar</span></h3><br/><br/>
