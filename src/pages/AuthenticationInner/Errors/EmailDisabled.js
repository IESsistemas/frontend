                            ...
                            <Row>
                                <Col lg={12}>
                                    <div className="text-center pt-4">
                                        ...
                                        <div className="mt-n4">
                                            <h3 className="text-uppercase">USUARIO PENDIENTE DE VALIDAR</h3>
                                            <h3 className="">Para poder ingresar es necesario que verifique su email</h3><br/>
