...
import UserDisabled from "../pages/AuthenticationInner/Errors/UserDisabled";
import EmailDisabled from "../pages/AuthenticationInner/Errors/EmailDisabled";
import Inprogress from "../pages/AuthenticationInner/Errors/Inprogress";
import ForgetPasswordPage from "../pages/Authentication/ForgetPassword";
import ForgetPassSuccessfull from "../pages/AuthenticationInner/SuccessMessage/ForgetPassSuccessfull";
//import Register from "../pages/Authentication/Register";
//import BasicSuccessMsg from "../pages/AuthenticationInner/SuccessMessage/BasicSuccessMsg";
import ChPassSuccess from "../pages/AuthenticationInner/SuccessMessage/BasicSuccessMsgChPass";
import Basic404 from "../pages/AuthenticationInner/Errors/Basic404";
import Home from "../pages/Home/Home";

import EncuestasSuccess from "../pages/surveysQuestions/Success";
//import Reglamento from "../pages/Reglamento/Reglamento";
//import EncuestasVoid from "../pages/Encuestas/EncuestasVoid";



import Career from "../pages/Career/Career";
import Yoenies from "../pages/Yoenies/Yoenies";
import Mycarrer from "../pages/MyCareer/MyCareer";
import EstadoCuenta from "../pages/EstadoCuenta/EstadoCuenta";
import RqSoftware from "../pages/RqSoftware/RqSoftware";
import FormSoftware from "../pages/RqSoftware/FormSoftware";
import Certificate from "../pages/Certificate/Certificate";
import Doa from "../pages/Doa/Doa";
import Directive from "../pages/Directive/Directive";
import DatosPersonales from "../pages/DatosPersonales/DatosPersonales";
import ChPass from "../pages/ChPass/ChPass";
import Legajo from "../pages/Legajo/Legajo";
import PartialsConfiguration from "../pages/DistanceCourses/Partials/PartialsConfiguration";
import PartialsConfigurationCies from "../pages/DistanceCourses/Partials/PartialsConfigurationsCies";
import Suggestions from "../pages/Suggestions/Suggestions";
import SuccessSuggestions from "../pages/AuthenticationInner/SuccessMessage/SuccessSuggestions";
import SurveysType from "../pages/surveys/SurveysType";
import Surveys from "../pages/surveys/Surveys";
import QuestionsStudentTeacher from "../pages/surveys/SurveysQuestions";
import QuestionsStudent from "../pages/surveysQuestions/QuestionsStudent";
import Analitico from "../pages/MisMaterias/Analitico/Analitico";
import Pagare from "../pages/MisMaterias/promissoryNote/PromissoryNote";
import Inscripcion from "../pages/MisMaterias/Inscripcion/Inscripcion";
import Calendario from "../pages/MisMaterias/Calendario/Calendario";




import ConsultSoftware from "../pages/RqSoftware/ConsultSoftware";
import Regulation from "../pages/Regulation/Regulation";
import SuccessSurveys from "../pages/surveysQuestions/Success";
import AcademicSchedule from "../pages/MisMaterias/academicSchedule/AcademicSchedule";
import Absence from "../pages/MisMaterias/absence/Absence";
import Reincorporation from "../pages/MisMaterias/reincorporation/Reincorporation";
import ScholarshipApplication from "../pages/MisMaterias/scholarshipApplication/ScholarshipApplication";
import ScholarshipDocumentation from "../pages/MisMaterias/scholarshipApplication/ScholarshipDocumentation";
import PaymentMethods from "../pages/MisMaterias/paymentMethods/PaymentMethods";
import GenerateVoucher from "../pages/MisMaterias/voucher/GenerateVoucher";
import Voucher from "../pages/MisMaterias/voucher/VoucherPrint";
import VirtualLibrary from "../pages/MisMaterias/virtualLibrary/VirtualLibrary";
import PartialsCorrected from "../pages/DistanceCourses/Partials/PartialsCorrected";
import PartialsCorrectedCies from "../pages/DistanceCourses/Partials/PartialCorrectedCies";
import SurveysQuestions from "../pages/surveys/SurveysQuestions";
import ScholarshipPrint from "../pages/MisMaterias/scholarshipApplication/ScholarshipPrint";
import AcademicExceptions from "../pages/MisMaterias/academicExceptions/academicExceptions";
import AcademicExceptionsConditional from "../pages/MisMaterias/academicExceptions/AcademicExceptionsConditional";
import AcademicExceptionsListener from "../pages/MisMaterias/academicExceptions/academicExceptionsListener";
import AcademicExceptionsAnotherCareer from "../pages/MisMaterias/academicExceptions/academicExceptionsAnotherCareer";
import AcademicExceptionPrint from "../pages/MisMaterias/academicExceptions/academicExceptionPrint";
import PromissoryNote from "../pages/MisMaterias/promissoryNote/PromissoryNote";
import PromissoryNotePrint from "../pages/MisMaterias/promissoryNote/PromissoryNotePrint";
import SchedulesSubjects from "../pages/MisMaterias/schedulesSubjects/SchedulesSubjects";
import CreditCard from "../pages/MisMaterias/creditCard/CreditCard";
import OptionsMisMaterias from "../pages/MisMaterias/OptionsMisMaterias/OptionsMisMaterias";
import DistanceCourses from "../pages/DistanceCourses/dashboard/DistanceCourses";

import DescargarModeloExamen from "../pages/MisExamenes/DescargarModeloExamen/DescargarModeloExamen";
import ExamenEspecial from "../pages/MisExamenes/ExamenEspecial/ExamenEspecial";
import FechaSeminario from "../pages/MisExamenes/FechaSeminario/FechaSeminario";
import InscripcionExamenCursillo from "../pages/MisExamenes/InscripcionExamenCursillo/InscripcionExamenCursillo";
import InscripcionExamenMateria from "../pages/MisExamenes/InscripcionExamenMateria/InscripcionExamenMateria";
import OptionsMisExamenes from "../pages/MisExamenes/OptionsMisExamenes/OptionsMisExamenes";
import VoucherPrint from "../pages/MisMaterias/voucher/VoucherPrint";
import PaymentButton from "../pages/MisMaterias/paymentButton/PaymentButton";
import MacroBank from "../pages/MisMaterias/paymentButton/MacroBanck";


const iesPublicRoutes = [
  { path: "/", component: <Login /> },
  { path: "/ies/auth", component: <Login /> },
  { path: "/ies/auth/disabled", component: <UserDisabled /> },
  { path: "/ies/auth/disabledemail", component: <EmailDisabled /> },
  { path: "/ies/forgot-password", component: <ForgetPasswordPage /> },
  { path: "/ies/forgot-password/success", component: <ForgetPassSuccessfull /> },
  { path: "/ies/suggestions", component: <Suggestions /> },
  { path: "/ies/suggestions/success", component: <SuccessSuggestions /> },
  { path: "/ies/surveys-success", component: <EncuestasSuccess /> },
  { path: "/ies/chpass-success", component: <ChPassSuccess /> },
  { path: "/ies/inprogress", component: <Inprogress /> },
  { path: "/*", component: <Basic404 /> },
  { path: "/ies/survey/success", component: <SuccessSurveys /> },
  { path: "/ies/materias/academic-exceptions-print", component: <AcademicExceptionPrint /> },
  
  { path: "/ies/materias/documentacion-print", component: <ScholarshipPrint /> },
  { path: "/ies/materias/imprimir-boleta-pago", component: <VoucherPrint /> },
  { path: "/ies/materias/imprimir-pagare", component: <PromissoryNotePrint /> },
  { path: "/ies/materias/macro", component: <MacroBank /> },
  
];

const iesAuthRoutes = [
  { path: "/ies/home", component: <Home /> },
  { path: "/ies/surveys", component: <Surveys /> },
  { path: "/ies/surveys-type/:id", component: <SurveysType /> },
  { path: "/ies/survey-questions/:id/:materia", component: <SurveysQuestions /> },

 
  /* 
  
   { path: "/ies/void-surveys", component: <EncuestasVoid /> }, */
  /*  { path: "/ies/regulation", component: <Reglamento /> }, */


  //{ path: "/ies/void-surveys", component: <EncuestasVoid /> },
  { path: "/ies/regulation", component: <Regulation /> },
  { path: "/ies/contacto", component: <Contacto /> },

  { path: "/ies/carrer", component: <Career /> },
  { path: "/ies/yoenies", component: <Yoenies /> },
  { path: "/ies/mycarrer", component: <Mycarrer /> },
  { path: "/ies/accountstatus", component: <EstadoCuenta /> },
  { path: "/ies/software", component: <RqSoftware /> },
  { path: "/ies/consult-software", component: <ConsultSoftware /> },
  { path: "/ies/rq-form-software", component: <FormSoftware /> },

  { path: "/ies/certificate", component: <Certificate /> },
  { path: "/ies/doa", component: <Doa /> },
  { path: "/ies/directive", component: <Directive /> },
 
  { path: "/ies/data", component: <DatosPersonales /> },
  { path: "/ies/chpass", component: <ChPass /> },
  { path: "/ies/legajo", component: <Legajo/> },
  { path: "/ies/lower-raise-partials", component: <PartialsConfiguration/>},
  { path: "/ies/lower-raise-partials-cies", component: <PartialsConfigurationCies/>}, 
  { path: "/ies/cursado-distancia", component: <DistanceCourses /> },
  { path: "/ies/cursado-distancia/parciales-corrregido", component: <PartialsCorrected/>},
  { path: "/ies/cursado-distancia/parciales-corrregido-cies", component: <PartialsCorrectedCies/>},
  { path: "/ies/legajo", component: <Legajo /> },


  { path: "/ies/materias/analitico", component: <Analitico /> },
  { path: "/ies/materias/inscripcion", component: <Inscripcion /> },
  { path: "/ies/materias/pagare", component: <PromissoryNote/> },

  { path: "/ies/materias/pagare", component: <Pagare /> },
  { path: "/ies/materias/tarjeta-credito", component: <CreditCard /> },
  { path: "/ies/materias/cronograma-academico", component: <AcademicSchedule /> },
  { path: "/ies/materias/inasistencias-reincorporaciones", component: <Absence /> },
  { path: "/ies/materias/reincorporaciones", component: <Reincorporation /> },
  { path: "/ies/materias/solicitud-beca", component: <ScholarshipApplication /> },
  { path: "/ies/materias/documentacion-beca", component: <ScholarshipDocumentation /> },
  { path: "/ies/materias/horarios-materias", component: <SchedulesSubjects /> },
  { path: "/ies/materias/formas-pago", component: <PaymentMethods /> },
  { path: "/ies/materias/generar-boleta-pago", component: <GenerateVoucher /> },
 
  { path: "/ies/materias/boton-de-pago", component: <PaymentButton /> },

  { path: "/ies/materias/boleta-pago", component: <Voucher /> },
  { path: "/ies/materias/biblioteca-virtual", component: <VirtualLibrary /> },
  { path: "/ies/materias/academic-exceptions", component: <AcademicExceptions /> },
  { path: "/ies/materias/academic-exceptions-conditional", component: <AcademicExceptionsConditional /> },
  { path: "/ies/materias/academic-exceptions-listener", component: <AcademicExceptionsListener /> },
  { path: "/ies/materias/academic-exceptions-another-career", component: <AcademicExceptionsAnotherCareer /> },
  { path: "/ies/materias", component: <OptionsMisMaterias /> },

  { path: "/ies/examenes/modelo-examen", component: <DescargarModeloExamen /> },
  //{ path: "/ies/examenes/examen-especial", component: <ExamenEspecial /> },
  { path: "/ies/examenes/fecha-seminario", component: <FechaSeminario /> },
  { path: "/ies/examenes/inscripcion-cursillo", component: <InscripcionExamenCursillo /> },
  { path: "/ies/examenes/inscripcion-materia", component: <InscripcionExamenMateria /> },
  { path: "/ies/examenes", component: <OptionsMisExamenes /> },
...
const templateAut = [
  ...
  // eslint-disable-next-line react/display-name
  {
    path: "/",
    exact: true,
    component: <Navigate to="/ies/auth" />,
  },
  { path: "*", component: <Navigate to="/ies/auth" /> },
];
...
*/
const authProtectedRoutes = [...iesAuthRoutes, /*...templateAut*/];
const publicRoutes = [...iesPublicRoutes, /*...templatePub*/];
